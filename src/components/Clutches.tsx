...
const Clutches: React.FC = () => {
    return (
        <section className="py-10">
            <h2 className="font-serif text-2xl font-bold text-center mb-6">Stylish Clutches</h2>
            ...
            <div className="flex flex-wrap justify-center">
                ...
                <div className="m-4 p-4 border rounded shadow-lg">
                    ...
                    <h3 className="font-serif font-semibold">Clutch Style 1</h3>
                ...
                <div className="m-4 p-4 border rounded shadow-lg">
                    ...
                    <h3 className="font-serif font-semibold">Clutch Style 2</h3>
