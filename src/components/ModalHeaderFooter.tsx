    ...
    <>
      ...
      <div className="sticky bottom-0 bg-background-50 rounded-b-xl px-6 py-4 flex justify-center gap-4 select-none z-30">
        <a
          ...
          className="inline-flex items-center justify-center bg-green-600 hover:bg-green-700 text-white rounded-full shadow-lg py-2 px-6 font-semibold text-sm transition-colors duration-300"
        >
          Reservar
        </a>
        ...
        {navigator.share && (
          <button
            ...
            className="inline-flex items-center justify-center bg-blue-600 hover:bg-blue-700 text-white rounded-full shadow-lg py-2 px-6 font-semibold text-sm transition-colors duration-300"
          >
            Compartilhar
          </button>
        )}
