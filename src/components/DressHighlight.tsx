...
const DressHighlight: React.FC = () => {
    return (
        <section className="py-10">
            <h2 className="font-serif text-3xl font-bold text-center mb-6">Featured Party Dresses</h2>
            <div className="flex flex-wrap justify-center">
                <div className="max-w-xs m-4 p-4 border rounded-lg shadow-lg">
                    ...
                    <h3 className="font-serif text-xl font-semibold">Elegant Evening Gown</h3>
                ...
                <div className="max-w-xs m-4 p-4 border rounded-lg shadow-lg">
                    ...
                    <h3 className="font-serif text-xl font-semibold">Chic Cocktail Dress</h3>
                ...
                <div className="max-w-xs m-4 p-4 border rounded-lg shadow-lg">
                    ...
                    <h3 className="font-serif text-xl font-semibold">Flirty Mini Dress</h3>
